...
native_executor_instance!(
	pub Executor,
	yalland_node_runtime::api::dispatch,
	yalland_node_runtime::native_version
);
...
mod tests {
	...
	use yalland_node_runtime::impls::LinearWeightToFee;
	...
	/// runtime.
	const COMPACT_CODE: &[u8] = yalland_node_runtime::WASM_BINARY;
	...
	const BLOATY_CODE: &[u8] = yalland_node_runtime::WASM_BINARY_BLOATY;

	const GENESIS_HASH: [u8; 32] = [69u8; 32];

	const VERSION: u32 = yalland_node_runtime::VERSION.spec_version;
